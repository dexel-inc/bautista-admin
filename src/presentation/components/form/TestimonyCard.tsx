              ...
              <div className="relative flex justify-end">
                ...
                >
                  <DropdownItem
                      ...
                      className="flex w-full gap-4 items-center font-normal text-left text-gray-500 hover:text-gray-500 dark:text-white dark:hover:text-white hover:bg-gray-500/10 rounded-lg"
                  >
                      <PencilIcon />
                      Editar
                  </DropdownItem>
