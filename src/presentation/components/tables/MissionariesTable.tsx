...
export default function MissionariesTable() {
  ...
  const handleStatusChange = (missionary: Partial<Missionary>, isActive: boolean) => {
                        ...
                        {missionary?.user?.email}
                            ...
                            <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                              <div className="flex items-center gap-2">
                                <Toggle
                                    isActive={!missionary.disabled_at}
                                    onChange={(isActive) => handleStatusChange(missionary, isActive)}
                                />
                                <span className="text-theme-xs">
                                    {!missionary.disabled_at ? "Activo" : "Inactivo"}
                                 </span>
                              </div>
                            </TableCell>
                          </TableRow>
